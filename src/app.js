...
import {httpLibrary} from './library.js'
...
function searchWeather(){
  ...
  http.sendHttpRequest(`https://api.openweathermap.org/data/2.5/forecast?id=${cityId}&appid=${apiKey}`).then(rd=> {
  ...
  http.sendHttpRequest(`https://api.openweathermap.org/data/2.5/weather?id=${cityId}&appid=${apiKey}`, "GET").then(rd => {
